...
# This method provides access to an objects nested properties
# Example: 
#   a = { b: { c : "foo" } }
#   // b is a direct property of a
#   // c is a direct property of b
#   // c is a nested property of a
#   getNestedValueForObject(a, 'b.c') => "foo"
...
jQuery ($) ->
  ...
  roomies.ui.setupAjaxLinks = ->
    roomies.ui.$body.delegate('a.ajax', 'click', ->
  ...
  roomies.init.push('ui.setupAjaxLinks')
