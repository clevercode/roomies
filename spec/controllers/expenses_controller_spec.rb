...
describe ExpensesController do
  ...
  def mock_expense(stubs={})
    @mock_expense ||= mock_model(Expense, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all expenses as @expenses" do
      Expense.stub(:all) { [mock_expense] }
      get :index
      assigns(:expenses).should eq([mock_expense])
    end
  end

  describe "GET show" do
    it "assigns the requested expense as @expense" do
      Expense.stub(:find).with("37") { mock_expense }
      get :show, :id => "37"
      assigns(:expense).should be(mock_expense)
    end
  end

  describe "GET new" do
    it "assigns a new expense as @expense" do
      Expense.stub(:new) { mock_expense }
      get :new
      assigns(:expense).should be(mock_expense)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created expense as @expense" do
        Expense.stub(:new).with({'these' => 'params'}) { mock_expense(:save => true) }
        post :create, :expense => {'these' => 'params'}
        assigns(:expense).should be(mock_expense)
      end

      it "redirects to the created expense" do
        Expense.stub(:new) { mock_expense(:save => true) }
        post :create, :expense => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expense as @expense" do
        Expense.stub(:new).with({'these' => 'params'}) { mock_expense(:save => false) }
        post :create, :expense => {'these' => 'params'}
        assigns(:expense).should be(mock_expense)
      end

      it "re-renders the 'new' template" do
        Expense.stub(:new) { mock_expense(:save => false) }
        post :create, :expense => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested expense as @expense" do
        Expense.stub(:find) { mock_expense(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:expense).should be(mock_expense)
      end
    ...
    describe "with invalid params" do
      it "assigns the expense as @expense" do
        Expense.stub(:find) { mock_expense(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:expense).should be(mock_expense)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the expenses list" do
      Expense.stub(:find) { mock_expense }
      delete :destroy, :id => "1"
